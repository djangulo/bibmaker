  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <div>
          <SemanticButton
            ...
            size="tiny"
            type="button"
            onClick={() => push('cdrom.authors', undefined)}
          />
        </div>
      </div>
      <FieldArray name="cdrom.authors">
        {({ fields }) =>
      ...
      <Field
        ...
        label={t('apa:edition')}
        component={InputAdapter}
        placeholder={t('apa:edition', 'Album')}
      />
      <Field
        name="cdrom.location"
