...
const OnlineEncyclopediaForm = ({ push }) => {
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <div>
          <SemanticButton
            ...
            size="tiny"
            type="button"
            onClick={() => push('onlineEncyclopedia.authors', undefined)}
          />
        </div>
      </div>
      <FieldArray name="onlineEncyclopedia.authors">
        {({ fields }) =>
      ...
      />
      <Field
        name="onlineEncyclopedia.entityName"
        label={t('apa:form.encyclopediaName')}
        component={InputAdapter}
        placeholder={t('apa:form.encyclopediaName', 'Encyclopedia name')}
      />
      <Field
        name="onlineEncyclopedia.location"
        label={t('apa:form.location')}
        component={InputAdapter}
        placeholder={t('apa:form.placeholder.location', 'Grand canyon, USA')}
      />
      <Field
        name="onlineEncyclopedia.publisher"
        label={t('apa:publisher')}
        component={InputAdapter}
        placeholder={t('apa:form.publisher', 'e.g. BBC Press')}
      />
      <Field
        name="onlineEncyclopedia.url"
...
export default OnlineEncyclopediaForm;
