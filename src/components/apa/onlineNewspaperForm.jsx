...
const OnlineNewspaperForm = ({ push }) => {
      ...
      >
        ...
        <div>
          <SemanticButton
            ...
            size="tiny"
            type="button"
            onClick={() => push('onlineNewspaper.authors', undefined)}
          />
        </div>
      </div>
      <FieldArray name="onlineNewspaper.authors">
        {({ fields }) =>
...
export default OnlineNewspaperForm;
