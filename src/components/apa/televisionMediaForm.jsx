...
const TelevisionMediaForm = ({ push }) => {
      ...
      >
        ...
        <div>
          <SemanticButton
            ...
            size="tiny"
            type="button"
            onClick={() => push('televisionMedia.authors', undefined)}
          />
        </div>
      </div>
      <FieldArray name="televisionMedia.authors">
        {({ fields }) =>
...
export default TelevisionMediaForm;
